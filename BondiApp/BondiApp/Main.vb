...
Friend Class Main
    ...
    Public backprices As List(Of backPrice)                                                                                            ' CALL THE FUNCTION TO PARSE THE DATA INTO ROWS AND RETURN OPEN MARKET HOURS.                        
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call m_utils.init(Me, Nothing, Nothing)
    ...
    Private Sub btnConnect_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnConnect.Click
        ...
        Call m_utils.addListItem(Utils.List_Types.SERVER_RESPONSES, "Connecting to TWS using clientId 0" & "...")                   ' ADD DESCRIPTION TO THE LIST BOX TO INDICATE STATUS

        Tws1.connect(txtHost.Text, txtPort.Text, 0, False, "")
    ...
    Private Sub btnTestConnect_Click(ByVal eventSender As System.Object, ByVal eventargs As System.EventArgs) Handles btnTestConnect.Click
    ...
    Private Sub Tws1_orderStatus(ByVal eventSender As System.Object, ByVal eventArgs As _DTwsEvents_orderStatusEvent) Handles Tws1.OnorderStatus
        ...
        msg = "order status: orderId=" & eventArgs.orderId & " client id=" & eventArgs.clientId & " permId=" & eventArgs.permId &
              " status=" & eventArgs.status & " filled=" & eventArgs.filled & " remaining=" & eventArgs.remaining &
              " avgFillPrice=" & eventArgs.avgFillPrice & " lastFillPrice=" & eventArgs.lastFillPrice &
